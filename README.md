    ...
    <main-sub-7>
      <div class="study">
        ...
        <div class="tokutyo-list">
          <img class="salesslill" src="salesskill (1).jpg">
    ...
    <main-sub-10>
      ...
      <div class="voise">
        ...
        <div class="busines-voise">
          ...
          <div class="yokoda">
            <div class="yokodaimg">
             <img class="yokodatake" src="take (1).jpg">
            </div>
          ...
          <div class="sato">
            <img class="minami" src="minami_sato (1).jpg">
          ...
          <div class="asada">
            <img class="yuri" src="asada (1).jpg">
